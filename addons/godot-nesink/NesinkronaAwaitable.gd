## [b](アドオン内もしくは実装内でのみ使用)[/b] 待機可能な単位を表すインターフェイスです。
...
enum {
	## [b](アドオン内もしくは実装内でのみ使用)[/b] まだ完了もしくはキャンセルされておらず待機中であることを表します。
	STATE_PENDING,
	## [b](アドオン内もしくは実装内でのみ使用)[/b] まだ完了もしくはキャンセルされておらず待機中であり、
	## 1 度以上 [method wait] メソッドにより待機している箇所があることを表します。
	STATE_PENDING_WITH_WAITERS,
	## [b](アドオン内もしくは実装内でのみ使用)[/b] 完了したことを表します。
	STATE_COMPLETED,
	## [b](アドオン内もしくは実装内でのみ使用)[/b] キャンセルされたことを表します。
	STATE_CANCELED,
}
